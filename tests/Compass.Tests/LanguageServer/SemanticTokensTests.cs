...
public sealed class SemanticTokensTests : LexerTestBase
{
    ...
    private sealed class Workspace : IDisposable
    {
        ...
        {
            Folder = Path.Combine(Path.GetTempPath(), $"compass-colors-{Guid.NewGuid():N}");
    ...
    {
        (IReadOnlyList<Colored> read, _) = Colors("Program.cm");
    ...
    public void AConstructorIsColoredAsTheTypeItBuilds()
    {
        ...
        (IReadOnlyList<Colored> read, _) = Colors("Beside.cm", Shapes);
