...
{
    private const string Uri = "file:///work/Program.cm";
    ...
    private static IReadOnlyList<Diagnostic> Scanned(string text)
    {
        ...
        _ = new Lexer(new SourceText(text, "Program.cm"), found).Scan();
    ...
    /// alone: both are <c>CM0006</c>, and only the one under the cursor should get a button.
    /// </para>
    /// </summary>
    [Test]
