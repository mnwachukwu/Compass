...
public sealed class LspTests
{
    ...
    [TestCase("file:///d%3A/Repos/Compass/samples/hello.cm")]
    [TestCase("file:///D%3A/Repos/Compass/samples/hello.cm")]
    [TestCase("file:///D:/Repos/Compass/samples/hello.cm")]
    public void ADriveLetterIsReadWhicheverWayItIsWritten(string uri)
    {
        Assert.That(
            Lsp.PathOf(uri),
            Is.EqualTo(Path.GetFullPath("D:/Repos/Compass/samples/hello.cm")).IgnoreCase);
    }
    ...
    public void AnEscapedSpaceIsASpace() =>
        Assert.That(
            Lsp.PathOf("file:///d%3A/My%20Programs/hello.cm"),
            Is.EqualTo(Path.GetFullPath("D:/My Programs/hello.cm")).IgnoreCase);
    ...
    public void AnEscapedSpaceIsASpaceWithNoDriveEither() =>
        Assert.That(
            Lsp.PathOf("file:///home/matt/My%20Programs/hello.cm"),
            Is.EqualTo("/home/matt/My Programs/hello.cm"));
    ...
    {
        string path = Lsp.PathOf("file:///d%3A/Repos/Compass/samples/hello.cm")!;
    ...
    [TestCase("vscode-remote://ssh/home/matt/x.cm")]
    [TestCase("")]
    [TestCase(null)]
    ...
    {
        string path = Path.Combine(Path.GetTempPath(), "compass files", "hello.cm");
    ...
    public void TheRightThingsFade() => Assert.Multiple(() =>
    {
        Assert.That(
            ...
            Does.Contain("CM0409").And.Contain("CM0410").And.Contain("CM0403"),
