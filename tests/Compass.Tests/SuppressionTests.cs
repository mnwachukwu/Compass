...
public sealed class SuppressionTests : LexerTestBase
{
    ...
    /// keeps warnings. Here `CM0340` is an opinion and survives a directive about warnings.
    /// </summary>
    [Test]
