...
public sealed class DeepEqualityTests
{
    ...
    private sealed class Node(int value) : ICompassModel
    {
        public int Value { get; set; } = value;

        public Node? Next { get; set; }

        // Emitted code gives each Compass type a .NET type of its own, so it answers with that.
    ...
    private sealed class OtherNode(int value) : ICompassModel
    {
    ...
    {
        CompassSet<int> a = new([1, 2, 3]);
        CompassSet<int> b = new([1, 2, 3]);
        CompassSet<int> c = new([1, 2, 4]);
        CompassSet<int> shorter = new([1, 2]);
    ...
    {
        CompassSet<Node> a = new([new Node(1), new Node(2)]);
        CompassSet<Node> b = new([new Node(1), new Node(2)]);
    ...
    {
        CompassSet<int> a = new([1, 2]);
        CompassSet<int> b = new([2, 1]);
