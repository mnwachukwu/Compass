...
public sealed class ResolverTests
{
    ...
    public void ABareNameMatchingAnInstanceFieldNamesTheFix()
    {
        ...
        Assert.Multiple(() =>
        {
            Assert.That(IdsOf(diagnostics), Is.EqualTo(new[] { "CM0204" }));
    ...
    public void ABareNameMatchingNothingIsSimplyNotFound()
    {
        ...
        Assert.That(IdsOf(diagnostics), Is.EqualTo(new[] { "CM0200" }));
    }
    ...
    public void ANestedScopeMayNotShadowAnOuterName(string written)
    {
        ...
        Assert.That(IdsOf(diagnostics), Is.EqualTo(new[] { "CM0237" }));
    }
    ...
    /// further in.
    /// </summary>
    [TestCase("        let parameter = 2;", "CM0202", TestName = "beside it, a duplicate")]
    [TestCase("        begin\n            let parameter = 2;\n        end", "CM0237",
    ...
    public void DeclaringTheSameNameTwiceInOneScopeIsRejected()
    {
        ...
        Assert.That(IdsOf(diagnostics), Is.EqualTo(new[] { "CM0202" }));
    }
    ...
    public void AssigningToAConstantLocalIsRejected()
    {
        ...
        Assert.That(IdsOf(diagnostics), Is.EqualTo(new[] { "CM0205" }));
    }
    ...
    public void AssigningToALoopVariableIsRejected()
    {
        ...
        Assert.Multiple(() =>
        {
            Assert.That(IdsOf(diagnostics), Is.EqualTo(new[] { "CM0206" }));
    ...
    public void AnUnknownTypeIsReportedOnce()
    {
        ...
        Assert.That(IdsOf(diagnostics), Is.EqualTo(new[] { "CM0201" }));
    }
    ...
    public void ACycleInInheritanceIsBrokenAndReported()
    {
        ...
        Assert.Multiple(() =>
        {
            Assert.That(IdsOf(diagnostics), Does.Contain("CM0207"));
    ...
    public void ExtendingASealedModelIsRejected()
    {
        ...
        Assert.That(IdsOf(diagnostics), Is.EqualTo(new[] { "CM0208" }));
    }
    ...
    public void ExtendingAStructureIsRejected()
    {
        ...
        Assert.That(IdsOf(diagnostics), Is.EqualTo(new[] { "CM0209" }));
    }
    ...
    public void SealedAndAbstractTogetherIsRejected()
    {
        ...
        Assert.That(IdsOf(diagnostics), Is.EqualTo(new[] { "CM0210" }));
    }
    ...
    public void ABuiltInTypeNameCannotBeRedeclared(string name)
    {
        ...
        Assert.That(IdsOf(diagnostics), Is.EqualTo(new[] { "CM0203" }));
    }
    ...
    public void ExtendingABuiltInThatIsNotModelOrAnExceptionIsRejected(string name)
    {
        ...
        Assert.That(IdsOf(diagnostics), Is.EqualTo(new[] { "CM0216" }));
    }
    ...
    public void DeclaringTheSameTypeTwiceIsRejected()
    {
        ...
        Assert.Multiple(() =>
        {
            Assert.That(IdsOf(diagnostics), Is.EqualTo(new[] { "CM0217" }));
    ...
    [TestCase("string ", "CM0218")]
    [TestCase("real ", "CM0218")]
    [TestCase("boolean ", "CM0218")]
    ...
    public void AFileWithNoProgramIsFineUnlessAnEntryPointWasAskedFor()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(IdsOf(with), Is.EqualTo(new[] { "CM0212" }));
        });
    }
    ...
    public void ProgramMustBeASharedModel()
    {
        ...
        Assert.That(IdsOf(diagnostics), Is.EqualTo(new[] { "CM0213" }));
    }
    ...
    public void AProgramWithoutMainIsAlwaysWrong()
    {
        ...
        Assert.That(IdsOf(diagnostics), Is.EqualTo(new[] { "CM0212" }));
    }
    ...
    public void ThisIsRejectedInASharedMember()
    {
        ...
        Assert.That(IdsOf(diagnostics), Is.EqualTo(new[] { "CM0214" }));
    }
    ...
    public void BaseNeedsAParent()
    {
        ...
        Assert.That(IdsOf(diagnostics), Is.EqualTo(new[] { "CM0215" }));
    }
    ...
    public void AParseErrorDoesNotProduceASecondDiagnosticHere()
    {
        ...
        Assert.That(IdsOf(diagnostics), Is.EqualTo(new[] { "CM0101" }),
