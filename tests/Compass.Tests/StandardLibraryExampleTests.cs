...
/// example dividing by a literal zero, which never reaches run time because <c>CM0324</c> refuses
...
public sealed class StandardLibraryExampleTests : LexerTestBase
{
    ...
    /// <para>Only untagged blocks. A fence marked <c>text</c> is notation rather than Compass —
    ...
    /// deliberately not Compass: it shows how a signature is written on the pages, which is
