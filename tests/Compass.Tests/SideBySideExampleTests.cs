...
/// <summary>
/// <para>Every Compass block in <c>docs/side-by-side.md</c> compiles.</para>
...
public sealed class SideBySideExampleTests : LexerTestBase
{
    ...
    /// (<c>CM0200</c>) and a namespace it never declares (<c>CM0227</c>).</para>
    ...
    private static readonly HashSet<string> Supplied =
        new(StringComparer.Ordinal) { "CM0200", "CM0227" };
    ...
    /// </summary>
    [Test]
    public void TheDocumentIsFullOfCompass() =>
