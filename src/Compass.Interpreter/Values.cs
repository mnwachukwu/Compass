...
/// </summary>
public sealed class Instance(DeclaredTypeSymbol type) : ICompassModel
{
    ...
    /// <para>Running one means evaluating a Compass function, which only the interpreter can
    ...
    /// <summary>
    /// The Compass type, since every instance the interpreter makes is this one host class and
