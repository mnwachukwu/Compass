...
/// <summary>
/// <para>The members every Compass type inherits from <c>Model</c>.</para>
...
public static class ModelOperations
{
    ...
    /// value, and .NET prints it — but scale is a thing Compass never talks about anywhere else,
    ...
    /// <summary>
    /// <para>Renders any value the way Compass prints it.</para>
    ...
    public static string ToDisplayString(object? value) => value switch
    {
        ...
        null => "empty",
        ICompassOptional { HasValue: false } => "empty",
        ICompassOptional present => ToDisplayString(present.GetValue()),
    ...
    public static string ToElementString(object? value) => value switch
    {
        ...
        ICompassOptional { HasValue: true } present => ToElementString(present.GetValue()),
    ...
    /// </summary>
    public static string StructureToString(string typeName, ICompassModel value)
    {
...
/// <para>Compass's <c>==</c> is structural, so this is how a program asks the question C#
...
/// </summary>
public static class CompassConsole
{
    ...
    /// </summary>
    public static void Write(string format, CompassSet<string> arguments)
    {
