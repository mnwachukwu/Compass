...
/// <para>This is the only exception Compass names that the base class library does not
...
/// exceptions and Compass ones nearly free.</para>
...
/// <para>Most of these are refused while compiling (`CM0243`). This catches the rest — a set
...
/// <summary>
/// <para>The exceptions a Compass program can name, and what each is at run time.</para>
...
public static class BuiltInExceptions
{
    ...
    public static bool MayBeCaught(string compassName) => !Uncatchable.Contains(compassName);

    /// <summary>
    /// <para>Maps a Compass exception name to the type it denotes.</para>
    ...
    [return: System.Diagnostics.CodeAnalysis.DynamicallyAccessedMembers(
        System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicConstructors)]
    public static Type? Resolve(string compassName)
    {
