...
/// <para><b>Written in the language's own types rather than the platform's.</b> A Compass
...
/// </summary>
public static class CompassMoments
{
    // ---- Making one -----------------------------------------------------------------------
    ...
    /// a name a Compass program can catch — the two are the same type — so nothing here has to
    /// translate it.</para>
    /// </summary>
