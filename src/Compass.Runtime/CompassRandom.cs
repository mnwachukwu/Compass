...
/// <summary>
/// <para>A source of random numbers, and everything Compass asks one for.</para>
...
/// </summary>
public sealed class CompassRandom
{
    ...
    /// </summary>
    public static CompassRandom Shared { get; } = new();

    public CompassRandom() => _source = new Random();
    ...
    /// </summary>
    public CompassRandom(long seed) => _source = new Random(unchecked((int)seed));
