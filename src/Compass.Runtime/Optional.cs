...
/// holds.</para>
/// <para>The same arrangement <see cref="ICompassSet"/> uses, and for the same reason: an
...
/// </summary>
public interface ICompassOptional
{
...
/// <summary>
/// <para>A value that may be absent. Compass has no null; this replaces it.</para>
...
/// </para>
/// </summary>
public readonly struct Optional<T> : IEquatable<Optional<T>>, ICompassOptional
{
    ...
    object? ICompassOptional.GetValue() => HasValue ? _value : null;
}
