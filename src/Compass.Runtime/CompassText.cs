...
/// </summary>
public static class CompassText
{
    ...
    /// the difference.</para>
    /// </summary>
    public static CompassSet<char> ToCharacters(string subject) => new(subject);

    /// <inheritdoc cref="ToCharacters"/>
    public static CompassSet<object?> ToCharactersUntyped(string subject) =>
    ...
    /// makes no difference to what comes out. <see cref="ICompassSet"/> is what lets one method
    /// take both.</para>
    /// </summary>
    public static string FromCharacters(ICompassSet these) => new(Characters(these));
    ...
    /// </summary>
    public static CompassSet<string> Split(string subject, string separator) =>
        new(Pieces(subject, separator));

    /// <inheritdoc cref="Split"/>
    public static CompassSet<object?> SplitUntyped(string subject, string separator) =>
    ...
    /// </summary>
    public static string Trim(string subject, ICompassSet these) =>
        subject.Trim(Characters(these));

    public static string TrimStart(string subject, ICompassSet these) =>
        subject.TrimStart(Characters(these));

    public static string TrimEnd(string subject, ICompassSet these) =>
    ...
    private static char[] Characters(ICompassSet these) =>
