...
/// is usually not valid Compass and has no version on disk to stand in for it.</para>
/// <para>Held by full path rather than by the URI it arrived as. An editor may say
/// <c>file:///c%3A/work/Program.cm</c> where a project says <c>Program.cm</c>, and a compilation
...
public sealed class DocumentStore
{
    ...
    /// pressing a key in <c>Program.cm</c> re-analyzes <c>Shelf.cm</c> beside it, which the
