...
public sealed record WorkspaceFolders(IReadOnlyList<string> Folders)
{
    ...
    /// the text of the two, since <c>D:\Repos\Compass-Editors</c> begins the same way as
    /// <c>D:\Repos\Compass</c> and is not inside it. A path that <em>is</em> the folder is inside
