...
/// <c>vocabulary</c> do: the answer depends on how a <c>.cmp</c> is read, and anything else
...
/// <para><b>Claiming is about what a project lists, not about where it sits.</b> A <c>.cmp</c>
