...
/// <summary>
/// <para>Reads a Compass project file, the <c>.cmp</c> that names what a build is made of.</para>
/// <para>It is written to read like Compass — words rather than punctuation, and a closing
/// <c>end</c> — but it is not Compass and nothing in it compiles. A project describes a build;
...
///     source Program.cm
///     source models
///     source services/Ledger.cm
///     output ../artifacts/bank
/// end project
/// </code>
/// <para>A <c>source</c> naming a folder takes every <c>.cm</c> directly inside it, and does
