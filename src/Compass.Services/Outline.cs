...
/// the compiler's, and anything else that wanted it would have to parse Compass a second time.
...
public static class Outline
{
    ...
    /// <para>Positions are one-based, as everything a reader sees in Compass is. Whatever counts
