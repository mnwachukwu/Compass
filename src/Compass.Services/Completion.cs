...
/// A reader who has just typed <c>word.</c> has written something that is not Compass and never
...
public static class Completion
{
    ...
    /// it.</para>
    /// </summary>
    private const string Placeholder = "__compass_completing__";
    ...
    /// <c>word.Cou</c> becomes <c>word.Cou__compass_completing__</c> — one name, in the one place
    ...
    /// <c>counter.__compass_completing__</c> — an expression with no semicolon, which is not a
