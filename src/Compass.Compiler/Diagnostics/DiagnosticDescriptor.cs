...
/// any of them.</para>
/// </summary>
/// <param name="Id">A stable identifier of the form <c>CM</c> followed by four digits.</param>
...
/// argumentless message, so one may hold a brace as punctuation: <c>CM0313</c> ends with
