...
namespace Compass.Compiler.Diagnostics;
...
/// <remarks>
/// <list type="table">
///   <item><term>CM0001-0099</term><description>Lexical</description></item>
///   <item><term>CM0100-0199</term><description>Syntax</description></item>
///   <item><term>CM0200-0299</term><description>Name resolution</description></item>
///   <item><term>CM0300-0399</term><description>Type checking</description></item>
///   <item><term>CM0400-0499</term><description>Definite assignment and flow</description></item>
///   <item><term>CM0500-0599</term><description>Lowering and emit</description></item>
///   <item><term>CM0600-0699</term><description>Project files and imports</description></item>
///   <item><term>CM9000+</term><description>Internal compiler errors</description></item>
/// </list>
/// </remarks>
public static class DiagnosticDescriptors
{
    ...
    /// <summary>
    /// Reported for operators a C# author reaches for that Compass does not have. Naming the
    ...
    public static readonly DiagnosticDescriptor NotAnOperator = Error(
        "CM0006",
        "Not an operator in Compass",
        "'{0}' is not an operator in Compass. {1}");
    ...
    /// <para>The same fault as <c>CM0324</c> and reported the same way: the bar in a fraction is
    ...
    // ---- Ignoring a diagnostic, CM0022 to CM0025 ------------------------------------------
    //
    ...
    public static readonly DiagnosticDescriptor IgnoreNamesNeither = Warning(
        ...
        "'{0}' is not 'warning', not 'opinion', and not an identifier such as 'CM0340'.");
    ...
    /// <c>CM0336</c>. The two rules meet with no gap and no overlap: a lambda writes its types
    ...
    // ---- Name resolution, CM0200 to CM0299 --------------------------------------------
    ...
    /// provided by Compass. <c>Standard.X</c> means "the language gives you this", and it can
    ...
    /// <para>Numbered past <c>CM0258</c>, which was retired the same day it was added. Reusing a
    ...
    /// <para>A warning rather than an error, for the reason <c>CM0327</c> is one: the program
    ...
    /// an older Compass program. Left to the ordinary machinery it is a cascade — <c>for</c>
    ...
    // ---- Documentation, CM0244 to CM0247 --------------------------------------------------
    //
    ...
    // ---- Type checking, CM0300 to CM0399 -----------------------------------------------
    ...
    /// name.</para>
    /// <para><c>CM0331</c> says this about a member a program declared, and offers marking it
    ...
    // ---- Definite assignment and flow, CM0400 to CM0499 --------------------------------
    ...
    /// such a loop still gets <c>CM0404</c>, because a function promising a result and holding
    ...
    /// <para>An opinion rather than an error, and for the same reason as <c>CM0406</c> beside
    ...
    // ---- Project files, CM0600 to CM0699 -----------------------------------------------
    ...
    public static readonly DiagnosticDescriptor ProjectSourceWrongExtension = Error(
        "CM0607",
        "Source is not Compass",
        "'{0}' is not a .cm file, so a project cannot build it.");
    ...
    public static readonly DiagnosticDescriptor ImportNotSource = Error(
        "CM0612",
        "Import is not Compass",
        "'{0}' is not a .cm file, so it cannot be compiled with this one.");
    ...
    // ---- Project references, CM0620 to CM0629 ---------------------------------------------
    ...
    public static readonly DiagnosticDescriptor ProjectReferenceIsNotAProject = Error(
        ...
        "'{0}' is not a .cmp file. A project references projects; it names files with 'source'.");
    ...
    // ---- Internal compiler errors, CM9000 and up -------------------------------------------
    //
