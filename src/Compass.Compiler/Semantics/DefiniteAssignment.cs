...
public sealed class DefiniteAssignment
{
    ...
    /// <para>Nothing at all is the third, and it is reported (<c>CM0406</c>) rather than
    ...
    /// program is broken in a way worth naming. So the end stays reachable, <c>CM0404</c>
