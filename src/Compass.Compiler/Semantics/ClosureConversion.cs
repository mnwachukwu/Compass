...
/// <para>The result is ordinary Compass. A frame is a model, its fields are fields, the body
...
public sealed class ClosureConversion
{
    ...
    /// refused (<c>CM0200</c>) rather than reaching forward. Taking the place before writing the
