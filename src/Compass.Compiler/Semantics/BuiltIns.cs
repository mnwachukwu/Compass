...
public enum BuiltInId
{
    ...
    /// <summary>One of each, which a Compass set does not otherwise guarantee.</summary>
    SetDistinct,
...
public static class BuiltIns
{
    ...
    [
        ...
        // type CM0324 leaves alone: there is an answer here, so there is nothing to refuse.
    ...
    [
        ...
        //
        // <para>A Compass set keeps its order and allows a value twice, so these are not the
        ...
        // the order the values were first met. This is what makes a Compass set into the set
