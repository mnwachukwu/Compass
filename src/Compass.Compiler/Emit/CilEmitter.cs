...
public sealed partial class CilEmitter
{
    ...
    /// it extends nothing — which is what Compass's <c>Model</c> is, so the root of every chain
    ...
    /// <summary>
    /// <para>The CLR type a Compass type becomes, primitives and declared models alike.</para>
    ...
    /// <summary>
    /// <para>Puts the Compass runtime next to the assembly that needs it.</para>
