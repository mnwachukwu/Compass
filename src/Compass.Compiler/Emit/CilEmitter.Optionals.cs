...
/// reference itself for the rest — because it has a null to reuse; Compass does not, and the
...
/// present is <c>CM0401</c>, refused long before this, so <c>Value</c> is a plain read and the
