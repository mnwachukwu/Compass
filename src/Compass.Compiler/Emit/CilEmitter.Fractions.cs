...
public sealed partial class CilEmitter
{
    ...
    private static MethodInfo PowerMethod(TypeSymbol? answer)
    {
        ...
        {
            return typeof(CompassArithmetic).GetMethod(
                nameof(CompassArithmetic.Power), [typeof(long), typeof(long)])!;
        }
        ...
        return typeof(CompassMath).GetMethod(
            nameof(CompassMath.Pow), [typeof(decimal), typeof(decimal)])!;
    }
}
