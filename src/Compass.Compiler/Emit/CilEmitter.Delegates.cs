...
/// <para><b>A delegate type per shape, not per name.</b> Two Compass types that take and yield
...
/// would make two values of the same Compass type refuse to be assigned to each other.</para>
...
public sealed partial class CilEmitter
{
    ...
    /// <summary>
    /// The delegate type a Compass function type becomes, made the first time that shape is
    /// wanted.
    /// </summary>
