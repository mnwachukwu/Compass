...
/// set. A <see cref="Runtime.CompassSet{T}"/> keeps its elements in a list, and a list's indexer
...
/// <c>CM0347</c> rather than a question with an answer. Nothing else can see the difference:
...
/// <c>CompassSet</c> a <c>ref</c> accessor fixes the index case and not identity. Rewriting
...
public sealed partial class CilEmitter
{
    ...
    /// behavior in <c>samples/structures.cm</c>.</para>
    /// </summary>
