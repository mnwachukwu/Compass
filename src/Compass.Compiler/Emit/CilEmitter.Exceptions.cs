...
/// <para><b>Compass's exceptions are .NET exceptions</b>, which is what makes this small. A model
...
public sealed partial class CilEmitter
{
    ...
    /// by <c>CM0331</c> long before, so nothing here asks whether the value is an exception.
    /// </summary>
