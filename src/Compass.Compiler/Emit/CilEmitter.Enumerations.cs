...
/// <summary>
/// <para>Enumerations, which become CLR enumerations — the same thing C# writes, so a Compass
...
public sealed partial class CilEmitter
{
    ...
    /// noticed.</para>
    /// <para>Backed by a 64-bit integer, because a Compass ordinal is an <c>integer</c> and that is
