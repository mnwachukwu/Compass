...
internal static class CilBuiltIns
{
    ...
    /// is a call into <see cref="Runtime.CompassMoments"/>, and several take one and answer with
    /// another.</para>
    /// </summary>
    ...
    /// model through <see cref="Runtime.ICompassModel"/>, which every model implements.</para>
    /// </summary>
