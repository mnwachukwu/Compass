...
/// <see cref="CompassText"/> — the very methods the interpreter calls.</para>
/// <para><b>Almost none of these is the framework method of the same name.</b> Compass compares
...
public sealed partial class CilEmitter
{
    ...
    /// boundary a set has — Compass counts with <c>integer</c>, and the CLR addresses text with
    /// <c>int</c>.</para>
    /// </summary>
        ...
        BuiltInId id)
    {
        ...
        switch (id)
        {
            ...
            // No position is narrowed on the way: a Compass integer already is what these take,
    ...
    {
        BuiltInId.StringContains => Text(nameof(CompassText.Contains), typeof(string), typeof(string)),
        BuiltInId.StringIndexOf => Text(nameof(CompassText.IndexOf), typeof(string), typeof(string)),

        BuiltInId.StringSubstring =>
            Text(nameof(CompassText.Substring), typeof(string), typeof(long), typeof(long)),
        BuiltInId.StringSubsetFrom => Text(nameof(CompassText.Subset), typeof(string), typeof(long)),
        BuiltInId.StringSubsetBetween =>
            Text(nameof(CompassText.Subset), typeof(string), typeof(long), typeof(long)),

        BuiltInId.StringInsert => Text(nameof(CompassText.Insert), typeof(string), typeof(string)),
        BuiltInId.StringInsertAt =>
            Text(nameof(CompassText.InsertAt), typeof(string), typeof(long), typeof(string)),
        BuiltInId.StringRemove => Text(nameof(CompassText.Remove), typeof(string), typeof(string)),
        BuiltInId.StringRemoveAt => Text(nameof(CompassText.RemoveAt), typeof(string), typeof(long)),

        BuiltInId.StringToCharacters => Text(nameof(CompassText.ToCharacters), typeof(string)),

        BuiltInId.StringTrim => Text(nameof(CompassText.Trim), typeof(string)),
        BuiltInId.StringTrimText => Text(nameof(CompassText.Trim), typeof(string), typeof(string)),
        BuiltInId.StringTrimSet => Text(nameof(CompassText.Trim), typeof(string), typeof(ICompassSet)),

        BuiltInId.StringTrimStart => Text(nameof(CompassText.TrimStart), typeof(string)),
        BuiltInId.StringTrimStartText =>
            Text(nameof(CompassText.TrimStart), typeof(string), typeof(string)),
        BuiltInId.StringTrimStartSet =>
            Text(nameof(CompassText.TrimStart), typeof(string), typeof(ICompassSet)),

        BuiltInId.StringTrimEnd => Text(nameof(CompassText.TrimEnd), typeof(string)),
        BuiltInId.StringTrimEndText =>
            Text(nameof(CompassText.TrimEnd), typeof(string), typeof(string)),
        BuiltInId.StringTrimEndSet =>
            Text(nameof(CompassText.TrimEnd), typeof(string), typeof(ICompassSet)),

        BuiltInId.StringSplit => Text(nameof(CompassText.Split), typeof(string), typeof(string)),
        BuiltInId.StringReplace =>
            Text(nameof(CompassText.Replace), typeof(string), typeof(string), typeof(string)),

        BuiltInId.StringToUpper => Text(nameof(CompassText.ToUpper), typeof(string)),
        BuiltInId.StringToLower => Text(nameof(CompassText.ToLower), typeof(string)),
        BuiltInId.StringCapitalize => Text(nameof(CompassText.Capitalize), typeof(string)),

        BuiltInId.StringToInteger or BuiltInId.IntegerParse =>
            Text(nameof(CompassText.ToInteger), typeof(string)),
        BuiltInId.StringToReal or BuiltInId.RealParse =>
            Text(nameof(CompassText.ToReal), typeof(string)),
        BuiltInId.StringToFloat or BuiltInId.FloatParse =>
            Text(nameof(CompassText.ToFloat), typeof(string)),
        BuiltInId.StringToBoolean or BuiltInId.BooleanParse =>
            Text(nameof(CompassText.ToBoolean), typeof(string)),
        BuiltInId.StringToCharacter or BuiltInId.CharacterParse =>
            Text(nameof(CompassText.ToCharacter), typeof(string)),
        BuiltInId.StringToFraction or BuiltInId.FractionParse =>
            Text(nameof(CompassText.ToFraction), typeof(string)),
    ...
    private static MethodInfo Text(string name, params Type[] taking) =>
        typeof(CompassText).GetMethod(name, taking)
