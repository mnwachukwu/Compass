...
export const compiler = {
    check: source => JSON.parse(exports.Compass.Wasm.Playground.Check(source)),
    run: (source, input) => JSON.parse(exports.Compass.Wasm.Playground.Run(source, input ?? '')),
    version: () => exports.Compass.Wasm.Playground.Version(),
};
